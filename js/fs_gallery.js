...
jQuery.fn.fs_gallery = function (fs_options) {
    ...
    jQuery('.portfolio_gallery').append('<div class="fs_gallery_wrapper"><ul class="' + fs_options.fit + ' fs_gallery_container ' + fs_options.fx + '"/></div>');
    $fs_container = jQuery('.fs_gallery_container');
    jQuery('.portfolio_gallery').append('<div class="mouse_icon"></div><div class="fs_controls ' + show_class + '"><div class="fs_controls_in"><a href="javascript:void(0)" class="fs_slider_prev"/><a href="javascript:void(0)" id="fs_play-pause" class="'+playpause+'"></a><a href="javascript:void(0)" class="fs_slider_next"/></div></div><div class="fs_thmb_viewport ' + show_class + '"><div class="fs_thmb_wrapper"><ul class="fs_thmb_list" style="width:' + fs_options.slides.length * 65 + 'px"></ul></div></div>');
    ...
    while (thisSlide <= fs_options.slides.length - 1) {
        ...
        $fs_thmb.append('<li class="fs_slide_thmb slide' + thisSlide + '" data-count="' + thisSlide + '"><img alt="' + fs_options.slides[thisSlide].alt + '" src="' + fs_options.slides[thisSlide].thmb + '"/><div class="fs_thmb_fadder"></div></li>');
        thisSlide++;
    }
    ...
    $fs_container.find('li.slide1').attr('style', 'background:url(' + $fs_container.find('li.slide1').attr('data-src') + ') no-repeat;');
   	...
   	$fs_thmb_viewport.width(jQuery(window).width() + 20);
...
jQuery(window).resize(function () {
   	jQuery('.fs_thmb_viewport').width(jQuery(window).width() + 20);
    jQuery('.fs_thmb_list').css('left', '0');
});
